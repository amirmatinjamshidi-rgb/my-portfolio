...
const projects = [
  ...
  },
  {
    id: 3,
    title: "Hotel Mojan",
    desc: "A hotel in Chabahar, fully develped backend and front end with a team,With a fully responsive design",
  ...
  {
    id: 4,
    title: "Hotel Mojan Admin Panel",
    desc: "Admin Panel with an overall score of a perfect 100 in lighthouse.",
    tech: ["React", "Next.js", "TypeScript"],
    link: "#",
    github: "#",
    image: "/Hotel.png",
        ...
        >
          <div className="relative h-56 w-full overflow-hidden">
            ...
            <Image
              ...
              fetchPriority="high"
              loading="eager"
              className="object-cover transform group-hover:scale-110 transition-transform duration-700 w-auto h-auto"
            />
          </div>
